...
export const CLINICAL_PROTOCOLS: ClinicalProtocol[] = [
  ...
  },
  {
    ...
    cie10: 'O14.1 / O15',
    severity: 'Crítica / Código Rojo',
    summary: 'Hipertensión del embarazo con daño de órgano blanco y/o convulsiones: emergencia materno-fetal tiempo-dependiente. La prioridad no es “normalizar” la presión: es prevenir ACV materno, cortar la convulsión con sulfato de magnesio, detectar HELLP/edema pulmonar y coordinar resolución obstétrica con madre estabilizada.',
    prehospitalManifestations: {
      setting: 'Gestante mayor de 20 semanas o puérpera con cefalea intensa, fosfenos, epigastralgia, hipertensión o convulsiones.',
      keySigns: ['TA ≥ 160 sistólica o ≥ 110 diastólica confirmada, o hipertensión menor con síntomas de severidad.', 'Cefalea intensa persistente, fosfenos/escotomas, visión borrosa, hiperreflexia, clonus o irritabilidad neurológica.', 'Dolor epigástrico o hipocondrio derecho, náuseas/vómitos y malestar: pensar HELLP aunque la TA no impresione.', 'Convulsión tónico-clónica generalizada en embarazo ≥20 semanas, parto o puerperio: eclampsia hasta demostrar lo contrario.', 'Disnea, ortopnea, rales o SatO2 baja: edema pulmonar por fuga capilar/sobrecarga.'],
      highSuspicionRedFlags: ['Convulsión activa, recurrente o recuperación neurológica incompleta.', 'TA severa persistente: riesgo inmediato de ACV hemorrágico.', 'Oliguria, creatinina elevada, plaquetas bajas, transaminasas elevadas o dolor HCD: daño de órgano blanco.', 'Sangrado, dolor abdominal continuo o útero hipertónico: desprendimiento placentario.', 'No esperar proteinuria para tratar si hay criterios de severidad.']
    },
    diagnosticAlgorithm: {
      initialSteps: ['ABCDE materno, decúbito lateral izquierdo, aspiración lista y protección de la vía aérea durante/post convulsión.', 'Confirmar edad gestacional, puerperio, síntomas de severidad, movimientos fetales y medicación previa.', 'No retrasar sulfato de magnesio por laboratorio, proteinuria o disponibilidad de ecografía fetal.', 'Llamar temprano a obstetricia, anestesia, neonatología y UCI: la paciente puede requerir parto/cesárea urgente tras estabilización.'],
      electrocardiogram: ['Monitor/ECG si dolor torácico, disnea, arritmia o uso de antihipertensivos IV.'],
      biomarkersAndLabs: ['Hemograma con plaquetas, creatinina, urea, ionograma, GOT/GPT, LDH, bilirrubina, coagulograma y fibrinógeno si sangrado/DPPNI.', 'Proteinuria o relación proteína/creatinina ayuda, pero no define la conducta ante eclampsia o daño de órgano.', 'Balance estricto: diuresis objetivo ≥25-30 ml/h; evitar sobrecarga hídrica.', 'Evaluación fetal cuando la madre esté estabilizada: primero salvar a la madre.'],
    ...
    management: {
      prehospitalAmbulance: ['Decúbito lateral izquierdo, ambiente con mínima estimulación, protección de cabeza y aspiración lista; no introducir objetos en la boca.', 'Oxígeno si SatO2 <94%, ventilación asistida si hipoventila o convulsión prolongada; glucemia capilar para descartar imitadores tratables.', 'Sulfato de magnesio 4-6 g IV en 15-20 min si eclampsia o preeclampsia con signos de severidad; si no hay IV y protocolo local lo permite, esquema IM.', 'Si convulsiona pese a magnesio: repetir 2 g IV y considerar benzodiacepina solo como rescate, con preparación para vía aérea.', 'Controlar TA severa con fármaco disponible y traslado con preaviso a maternidad con quirófano, banco de sangre, neonatología y UCI.'],
      emergencyRoomShockRoom: ['Carga de MgSO4 si no fue administrada y mantenimiento 1-2 g/h; monitorizar reflejo patelar, frecuencia respiratoria, sensorio y diuresis.', 'Antihipertensivos si TA ≥160/110: objetivo inicial <160/<110 y luego 140-150/90-100, evitando caídas bruscas que comprometan perfusión placentaria/cerebral.', 'Laboratorio HELLP/coagulopatía, balance hídrico estricto y evaluación de edema pulmonar; usar cristaloides con prudencia.', 'Si toxicidad por magnesio: suspender infusión, oxígeno/ventilación y gluconato de calcio 10% 10 ml IV lento.', 'Resolución obstétrica cuando la madre esté estabilizada; la eclampsia no se “cura” hasta finalizar embarazo/placenta cuando corresponde.'],
      initialPharmacotherapy: [
        ...
        { drug: 'Labetalol', dose: '20 mg IV, luego 40-80 mg c/10 min según respuesta', route: 'IV', notes: 'Evitar en asma grave, insuficiencia cardíaca descompensada, BAV o bradicardia.' },
        { drug: 'Hidralazina', dose: '5-10 mg IV c/20 min según TA', route: 'IV', notes: 'Alternativa validada; vigilar taquicardia e hipotensión.' },
        { drug: 'Nifedipina inmediata', dose: '10 mg VO, repetir a 20 min si persiste TA severa', route: 'VO', notes: 'No sublingual; útil si no hay acceso IV inmediato.' }
      ]
    },
    therapeuticWindow: {
      ...
      contraindications: ['No demorar magnesio esperando laboratorio/proteinuria.', 'Evitar descensos bruscos de TA: tratar riesgo de ACV sin provocar hipoperfusión.', 'No usar diazepam/fenitoína como primera línea si hay MgSO4 disponible.', 'No sobrecargar fluidos: alto riesgo de edema pulmonar.', 'No usar nifedipina sublingual.']
    },
    evidenceAndPrognosis: {
  ...
  },
  {
    ...
    cie10: 'O44 / O45 / O72',
    severity: 'Crítica / Código Rojo',
    summary: 'Sangrado obstétrico mayor: no esperar hipotensión para actuar, porque en embarazadas el shock aparece tarde. Pensar en 4T postparto (tono, tejido, trauma, trombina) y en causas anteparto letales (placenta previa, DPPNI, rotura uterina). La ventana útil del ácido tranexámico en HPP es precoz, ideal dentro de las 3 horas.',
    prehospitalManifestations: {
      setting: 'Gestante con sangrado vaginal abundante o puérpera con sangrado excesivo tras parto/cesárea.',
      keySigns: ['Taquicardia, palidez, piel fría, relleno capilar lento y ansiedad: pueden preceder a la hipotensión.', 'Sangrado vaginal >500 ml o cualquier sangrado con compromiso hemodinámico; >1000 ml se considera hemorragia mayor.', 'Placenta previa: sangrado rojo, indoloro, recurrente; DPPNI: dolor continuo, útero hipertónico y sufrimiento fetal.', 'Postparto: útero blando/alto sugiere atonía; placenta incompleta sugiere retención; dolor/laceraciones sugieren trauma.'],
      highSuspicionRedFlags: ['Shock o sangrado que empapa compresas/sábanas rápidamente.', 'Dolor abdominal continuo + hipertonía uterina: DPPNI hasta demostrar lo contrario.', 'Sangrado por sitios de punción, equimosis o fibrinógeno bajo: coagulopatía/DIC.', 'Ante sospecha de placenta previa: NO tacto vaginal hasta definir localización placentaria.', 'Evisceración uterina, dolor súbito poscesárea o pérdida de estación fetal: pensar rotura uterina.']
    },
    diagnosticAlgorithm: {
    ...
    management: {
      prehospitalAmbulance: ['Decúbito lateral izquierdo, oxígeno si hipoxemia, abrigo activo y mínima demora en escena.', 'Dos vías gruesas/IO si shock; cristaloides tibios solo como puente, evitando dilución si hay posibilidad de sangre.', 'Postparto: masaje uterino firme si útero blando; colocar al RN al pecho si es seguro puede favorecer oxitocina endógena.', 'Cuantificar sangrado por pesaje/estimación seriada y registrar hora de parto/inicio: define ventana de TXA.', 'Traslado urgente con preaviso “código hemorragia obstétrica”: obstetricia, anestesia, quirófano y banco de sangre.'],
      emergencyRoomShockRoom: ['Activar protocolo de hemorragia masiva con reposición balanceada, calcio, fibrinógeno/crioprecipitado según laboratorio y control de temperatura.', 'Postparto: masaje bimanual, oxitocina, TXA precoz y búsqueda sistemática de 4T.', 'Si atonía no cede: uterotónicos adicionales, balón intrauterino/taponamiento y escalada a suturas compresivas, embolización o cirugía.', 'Si anteparto severo: estabilización materna y resolución obstétrica; en DPPNI vigilar coagulopatía con fibrinógeno.', 'Evisceración o placenta retenida con sangrado: no insistir maniobras prolongadas fuera de quirófano.'],
      initialPharmacotherapy: [
        ...
        { drug: 'Misoprostol', dose: '800 mcg sublingual o 800-1000 mcg rectal', route: 'SL/rectal', notes: 'Coadyuvante si faltan uterotónicos o persiste atonía.' },
        { drug: 'Metilergometrina', dose: '0.2 mg IM', route: 'IM', notes: 'Evitar en hipertensión, preeclampsia o enfermedad vascular.' },
        { drug: 'Carboprost', dose: '250 mcg IM c/15-90 min', route: 'IM', notes: 'Evitar en asma; usar según disponibilidad/protocolo local.' },
    ...
    therapeuticWindow: {
      ...
      contraindications: ['No tacto vaginal ante sospecha de placenta previa.', 'No retrasar transfusión si shock o sangrado masivo: la Hb inicial puede engañar.', 'Evitar hipotermia, acidosis, hipocalcemia y dilución con cristaloides.', 'No dar metilergometrina en HTA/preeclampsia ni carboprost en asma.', 'No usar TXA como sustituto del control mecánico/quirúrgico de la causa.']
    },
    evidenceAndPrognosis: {
  ...
  },
  {
    ...
    cie10: 'O00.9',
    severity: 'Crítica / Código Rojo',
    summary: 'Rotura de embarazo extrauterino con hemoperitoneo: una de las causas más traicioneras de shock en mujer fértil porque el sangrado vaginal puede ser mínimo. Dolor pélvico + síncope o dolor de hombro + test positivo es quirófano hasta demostrar lo contrario.',
    prehospitalManifestations: {
    ...
    diagnosticAlgorithm: {
      initialSteps: ['ABCDE y reanimación de shock; activar ginecología/cirugía desde triage si hay inestabilidad.', 'Toda mujer en edad fértil con dolor abdominal, síncope o shock requiere test de embarazo urgente.', 'Eco FAST/transvaginal si disponible, pero inestable + embarazo positivo + líquido libre/peritonismo no debe esperar confirmación completa.', 'Buscar factores de riesgo: ectópico previo, EPI, cirugía tubaria, reproducción asistida, DIU, tabaquismo.'],
    ...
    management: {
      prehospitalAmbulance: ['Oxígeno si hipoxemia, dos vías gruesas/IO y abrigo activo.', 'Cristaloides tibios titulados solo como puente; si hay sangre disponible, priorizar reanimación hemostática.', 'No demorar traslado por analgesia, ecografía o interrogatorio extenso; llevar envases/antecedentes si están a mano.', 'Preaviso como shock hemorrágico gineco-obstétrico a centro con quirófano, ginecología y banco de sangre.'],
      emergencyRoomShockRoom: ['Ginecología/cirugía inmediata: laparoscopia si estable y laparotomía si shock o hemoperitoneo masivo.', 'Transfusión temprana si shock; activar hemorragia masiva si responde mal a fluidos.', 'Anti-D si Rh negativo no sensibilizada, según edad gestacional/protocolo.', 'Analgesia titulada, antiemético, control de temperatura y reevaluación abdominal/hemodinámica continua.', 'Metotrexato queda reservado para ectópico no roto, estable y con criterios estrictos: nunca en shock.'],
      initialPharmacotherapy: [
    ...
    therapeuticWindow: {
      ...
      contraindications: ['No metotrexato si inestable, ruptura, dolor significativo o hemoperitoneo.', 'No descartar por sangrado vaginal escaso: la hemorragia crítica suele ser intraperitoneal.', 'No demorar quirófano por β-hCG seriadas, TC o eco formal si shock.', 'No olvidar anti-D en Rh negativo.']
    },
    evidenceAndPrognosis: {
  ...
  },
  {
    ...
    cie10: 'O85 / O08.0',
    severity: 'Crítica / Código Rojo',
    summary: 'Sepsis en embarazo, postaborto o puerperio: puede progresar rápido y presentarse con poca fiebre. El tratamiento efectivo combina paquete de sepsis en la primera hora, antibióticos de amplio espectro y control de foco obstétrico temprano; los antibióticos solos no resuelven restos infectados o abscesos.',
    prehospitalManifestations: {
      ...
      highSuspicionRedFlags: ['Shock séptico, lactato elevado o necesidad de vasopresores.', 'Dolor desproporcionado, crepitación, necrosis o progresión cutánea: fascitis/Clostridium.', 'Sangrado con coagulopatía, plaquetas bajas o fibrinógeno bajo.', 'Oliguria, hipoxemia, confusión o ictericia: disfunción orgánica.', 'Aborto reciente/inseguro o retención de restos + fiebre/dolor: foco que requiere evacuación.']
    },
    diagnosticAlgorithm: {
    ...
    management: {
      ...
      emergencyRoomShockRoom: ['Primera hora: lactato, hemocultivos si no demoran, antibióticos amplio espectro y fluidos si hipotensión/hipoperfusión.', 'Cristaloides 30 ml/kg si shock o lactato alto, reevaluando por riesgo de edema pulmonar en embarazo/puerperio.', 'Noradrenalina si PAM <65 pese a fluidos o shock profundo; no esperar completar litros si está mal perfundida.', 'Control de foco sin demora: evacuación uterina, drenaje de absceso, revisión de herida/cesárea o laparotomía según causa.', 'Monitoreo materno-fetal y UCI; estabilizar a la madre es la intervención fetal más importante.'],
      initialPharmacotherapy: [
    ...
    therapeuticWindow: {
      ...
      contraindications: ['No esperar cultivos, procalcitonina o imagen para antibióticos si shock/alta sospecha.', 'No demorar control de foco: restos retenidos/abscesos/heridas infectadas perpetúan el shock.', 'No priorizar estudios fetales sobre estabilización materna.', 'No subestimar hipotermia o ausencia de fiebre.', 'No usar curetaje/evacuación sin antibiótico y reanimación adecuados.']
    },
    evidenceAndPrognosis: {
  ...
  },
  {
    ...
    cie10: 'O80 / O66.0',
    severity: 'Urgencia / Código Amarillo',
    summary: 'Parto extrahospitalario inevitable y distocia de hombros: situación de bajo recurso y alto impacto. La clave es decidir rápido si se puede trasladar o si el nacimiento es inminente, recibir al RN con calor y ventilación disponibles, prevenir hemorragia y, ante distocia, ejecutar maniobras en secuencia sin traccionar cuello.',
    prehospitalManifestations: {
    ...
    management: {
      prehospitalAmbulance: ['Si hay coronamiento y pujos involuntarios: asistir parto en lugar seguro; si no, traslado lateral izquierdo con preaviso.', 'Higiene, privacidad, guantes/campo limpio y control de salida de cabeza con apoyo suave del periné: no tirar.', 'Tras salida de cabeza, verificar circular de cordón; si está floja, deslizar; si ajustada e impide nacimiento, clampar/cortar según protocolo.', 'RN: secar vigorosamente, retirar paños húmedos, contacto piel a piel/abrigo, evaluar respiración, tono y FC; ventilar si apnea/gasping o FC <100.', 'Clampaje tardío 30-60 s si RN vigoroso; técnica limpia para corte.', 'Distocia: pedir ayuda, anunciar hora, McRoberts + presión suprapúbica; si no resuelve, maniobras internas/posición cuatro apoyos si entrenado. NO presión fúndica ni tracción cervical.', 'Postparto: manejo activo del tercer período, vigilar sangrado, masaje uterino si atonía y trasladar madre/RN aunque parezcan estables.'],
      emergencyRoomShockRoom: ['Equipo obstétrico/neonatal, calentador, aspiración si precisa y material de reanimación neonatal.', 'Distocia: McRoberts, presión suprapúbica, Rubin/Woods, extracción de brazo posterior, Gaskin; documentar tiempos y maniobras.', 'Reanimación neonatal con ventilación a presión positiva si RN no respira/gaspea o FC <100; compresiones si FC <60 pese a ventilación efectiva.', 'Manejo activo del alumbramiento con oxitocina y tracción controlada solo por personal entrenado.', 'Control de laceraciones, retención placentaria, atonía y hemorragia postparto.'],
      initialPharmacotherapy: [
    ...
    therapeuticWindow: {
      ...
      contraindications: ['No traccionar cabeza/cuello fetal.', 'No presión fúndica: empeora impactación y aumenta lesión fetal/materna.', 'No hacer barridos agresivos de vía aérea en RN vigoroso.', 'No demorar calor neonatal: la hipotermia empeora hipoglucemia y depresión respiratoria.', 'No olvidar registrar hora de nacimiento, APGAR/estado y hora de placenta.']
    },
    evidenceAndPrognosis: {
  ...
  },
  {
    ...
    cie10: 'T40.0-T40.6',
    severity: 'Crítica / Código Rojo',
    summary: 'Toxidrome opioide clásico: coma, bradipnea/apnea y miosis, aunque la miosis puede faltar si hay hipoxia profunda o coingestas. La muerte es por hipoventilación: primero abrir vía aérea y ventilar; la naloxona se titula al objetivo correcto, que es respirar, no “despertar perfecto”.',
    prehospitalManifestations: { setting: 'Sobredosis accidental/intencional con fentanilo, morfina, metadona, tramadol, heroína, parches transdérmicos o analgésicos combinados.', keySigns: ['FR <8/min, apnea, ronquido, gorgoteo o respiración agónica.', 'Glasgow bajo/coma con hipotonía y escasa respuesta al dolor.', 'Miosis puntiforme; si hay midriasis no descarta, pensar hipoxia, paro o coingesta.', 'Bradicardia, hipotensión, cianosis, edema pulmonar no cardiogénico o aspiración.'], highSuspicionRedFlags: ['Apnea, cianosis o SatO2 baja: ventilación inmediata antes/durante naloxona.', 'Re-sedación tras respuesta inicial: metadona, buprenorfina, fentanilos potentes o preparados de liberación prolongada.', 'Policonsumo con alcohol/benzodiacepinas/gabapentinoides: puede requerir vía aérea aunque revierta parcialmente.', 'Trauma, hipotermia, hipoglucemia o intento autolítico asociados.'] },
    ...
    management: { prehospitalAmbulance: ['Apertura de vía aérea, aspiración si vómitos/secreciones y ventilación con bolsa-válvula-máscara si apnea o FR crítica: no esperar a que haga efecto naloxona.', 'Naloxona titulada: 0.04-0.4 mg IV si hay vía y se busca evitar abstinencia; 2 mg IM/IN o spray 4 mg IN si apnea, paro o sin acceso IV.', 'Repetir cada 2-3 min hasta ventilación adecuada; si no responde, reconsiderar diagnóstico y manejar como coma indiferenciado.', 'Monitorizar por re-sedación al menos 2-3 h y más si metadona/buprenorfina/liberación prolongada; traslado si necesitó dosis repetidas.', 'Prevenir aspiración, hipotermia y trauma; llevar parches/envases y activar salud mental si intencional.'], emergencyRoomShockRoom: ['Soporte ventilatorio e intubación si no protege vía aérea, aspiración masiva, edema pulmonar o coingestas depresoras.', 'Infusión de naloxona si reaparece depresión respiratoria: iniciar aproximadamente con 2/3 de la dosis total efectiva por hora.', 'Rx tórax/gases si hipoxia persistente, aspiración o edema pulmonar; tratar complicaciones, no “castigar” con abstinencia innecesaria.', 'Evaluación de riesgo suicida, consumo problemático y derivación a tratamiento; considerar observación prolongada por opioides largos.'], initialPharmacotherapy: [{ drug: 'Naloxona', dose: '0.04-0.4 mg IV titulado; 2 mg IM/IN o 4 mg IN spray si apnea/sin vía; repetir c/2-3 min', route: 'IV/IM/IN', notes: 'Objetivo: FR, volumen corriente y Sat adecuados; no despertar completo.' }, { drug: 'Infusión de naloxona', dose: '2/3 de dosis efectiva por hora', route: 'IV continua', notes: 'Para opioides largos, fentanilos potentes o re-sedación.' }] },
  ...
  },
  {
    ...
    cie10: 'T60.0',
    severity: 'Crítica / Código Rojo',
    summary: 'Síndrome colinérgico severo por plaguicidas. La escena también intoxica al equipo. La prioridad real es descontaminar, aspirar secreciones, oxigenar y atropinizar hasta “pulmones secos”; no se titula a pupilas ni frecuencia cardíaca.',
    ...
    management: { prehospitalAmbulance: ['EPP antes de tocar: guantes, protección ocular/respiratoria si aerosoles; retirar ropa y embolsar doble.', 'Lavar piel y ojos con abundante agua; evitar contaminar ambulancia, camilla y guardia.', 'Oxígeno, aspiración frecuente, BVM o intubación si broncorrea/debilidad; idealmente después de atropina inicial y con equipo preparado.', 'Atropina IV repetida hasta mejorar ventilación y secar secreciones bronquiales; taquicardia no contraindica si sigue broncorreico.', 'Pralidoxima precoz si organofosforado moderado-severo, debilidad/fasciculaciones o exposición conocida; traslado a UCI/toxicología.'], emergencyRoomShockRoom: ['Atropinización agresiva: 2-5 mg IV adulto y duplicar cada 3-5 min hasta pulmones secos, Sat mejora y resistencia aérea baja.', 'Luego infusión de atropina 10-20% de la dosis total de carga por hora, ajustada a secreciones.', 'Pralidoxima: carga 1-2 g IV en 30 min y mantenimiento; más útil antes del envejecimiento enzimático.', 'Benzodiacepinas para convulsiones/agitación; soporte ventilatorio prolongado si síndrome intermedio.', 'Vigilar 24-96 h por recurrencia, debilidad proximal/cuello y falla respiratoria tardía.'], initialPharmacotherapy: [{ drug: 'Atropina', dose: '2-5 mg IV adulto, duplicar c/3-5 min hasta secreciones secas; niño 0.05 mg/kg', route: 'IV/IO', notes: 'No hay dosis máxima; meta respiratoria, no pupilar.' }, { drug: 'Pralidoxima', dose: '1-2 g IV en 30 min, luego 500 mg/h o 8-10 mg/kg/h', route: 'IV', notes: 'Más útil precozmente en organofosforados; ajustar a protocolo local.' }, { drug: 'Diazepam/Midazolam', dose: 'Según convulsión', route: 'IV/IM', notes: 'Convulsiones, fasciculaciones intensas y agitación.' }] },
    therapeuticWindow: { timeframe: 'Minutos-horas: atropinizar antes de falla respiratoria; pralidoxima es más efectiva antes del envejecimiento enzimático.', goldStandard: 'EPP/descontaminación + ventilación/aspiración + atropina titulada a secreciones + pralidoxima si corresponde.', alternativeReperfusion: 'Traslado a UCI/toxicología con soporte respiratorio y antídotos en curso.', contraindications: ['No trasladar ropa contaminada sin embolsar.', 'No subdosificar atropina por taquicardia o midriasis.', 'No demorar ventilación por antídotos.', 'Evitar succinilcolina si hay alternativa por metabolismo alterado de colinesterasas.', 'No usar pupilas como marcador de atropinización.'] },
  ...
  },
  {
    ...
    cie10: 'T58',
    severity: 'Crítica / Código Rojo',
    summary: 'Hipoxia tisular oculta por carboxihemoglobina y disfunción mitocondrial. La pulsioximetría convencional puede verse normal mientras cerebro y miocardio están hipóxicos. Oxígeno al 100% inmediato, evaluación neurológica/cardiaca y considerar cámara hiperbárica en criterios de gravedad, especialmente embarazo.',
    ...
    management: { prehospitalAmbulance: ['Retiro de exposición solo con escena segura; si hay varios pacientes con cefalea/náuseas sin fiebre, pensar CO hasta demostrar lo contrario.', 'Oxígeno 100% con reservorio de alto flujo o ventilación asistida; no guiarse por SpO2 convencional.', 'Intubar si coma, convulsiones, aspiración o falla ventilatoria; tratar trauma/quemaduras asociadas.', 'Traslado a centro con co-oximetría, ECG/troponina y posibilidad de consulta hiperbárica; embarazo = umbral bajo.', 'Notificar a bomberos/gas para clausurar fuente y evitar víctimas secundarias.'], emergencyRoomShockRoom: ['Oxígeno 100% hasta estar asintomático, típicamente 4-5 h, y COHb en descenso; controles neurológicos seriados.', 'Co-oximetría venosa o arterial, ECG y troponina: lesión miocárdica aumenta mortalidad tardía.', 'Considerar oxígeno hiperbárico si COHb >25-30%, pérdida de conciencia, déficit neurológico, neuropsicométrico anormal, acidosis severa, isquemia/arrítmia o embarazo.', 'En incendio cerrado, sospechar cianuro si lactato muy alto/shock: hidroxocobalamina según protocolo.', 'Explicar riesgo de síndrome neurológico tardío y programar seguimiento.'], initialPharmacotherapy: [{ drug: 'Oxígeno al 100%', dose: 'FiO2 1.0 continuo', route: 'Máscara reservorio / VM', notes: 'Tratamiento inmediato aunque la saturación parezca normal.' }, { drug: 'Oxígeno hiperbárico', dose: 'Según centro hiperbárico', route: 'Cámara hiperbárica', notes: 'Criterios: LOC, neuro, cardiaco, acidosis, COHb alta o embarazo.' }, { drug: 'Hidroxocobalamina', dose: '5 g IV', route: 'IV', notes: 'Incendio con sospecha de cianuro concomitante.' }] },
    therapeuticWindow: { timeframe: 'Oxígeno inmediato; hiperbárica idealmente precoz si indicada, sin demorar O2 normobárico al 100%.', goldStandard: 'Retiro de fuente + O2 100% + co-oximetría + evaluación neurológica/cardiaca + hiperbárica en criterios de gravedad.', alternativeReperfusion: 'Si no hay cámara, O2 100% prolongado y traslado solo si el beneficio supera riesgo/logística.', contraindications: ['No tranquilizarse por SatO2 normal.', 'No correlacionar gravedad solo con COHb: pesan clínica, tiempo desde exposición y O2 recibido.', 'No alta rápida si síncope, embarazo, acidosis, dolor torácico o déficit neuro.', 'No reingresar al ambiente sin control técnico.'] },
  ...
  },
  {
    ...
    cie10: 'T43.0 / T43.2',
    severity: 'Crítica / Código Rojo',
    summary: 'Sobredosis cardiotóxica con bloqueo de canales de sodio: QRS ancho, R terminal en aVR, convulsiones, hipotensión y arritmias. La flashcard se decide por ECG seriado: bicarbonato hipertónico temprano salva vida; fisostigmina/flumazenil pueden matar.',
    ...
    management: { prehospitalAmbulance: ['Oxígeno, glucemia, vía aérea temprana si coma, convulsiones o pérdida de reflejos; evitar hipoxia/acidosis porque empeoran cardiotoxicidad.', 'ECG de 12 derivaciones y monitor: QRS >100 ms ya es alarma; QRS >160 ms alto riesgo de arritmia ventricular.', 'Bicarbonato si QRS ancho, hipotensión o arritmia y está disponible; repetir guiado por ECG.', 'Benzodiacepinas para convulsiones/agitación; NO flumazenil ni fisostigmina en sobredosis mixta/desconocida.', 'Traslado a UCI/toxicología con preaviso por posible colapso súbito.'], emergencyRoomShockRoom: ['Bicarbonato 1-2 mEq/kg IV en bolos repetidos hasta QRS estrecho, mejora hemodinámica o pH 7.50-7.55; controlar K+.', 'Infusión alcalinizante según protocolo si recurrencia del QRS ancho; evitar alcalosis/hipokalemia extremas.', 'Vasopresores, preferentemente noradrenalina, si hipotensión tras bicarbonato y fluidos prudentes.', 'Carbón activado si presentación precoz/ingesta masiva y vía aérea protegida.', 'Emulsión lipídica IV, ECMO o soporte circulatorio como rescate en colapso refractario con toxicología.'], initialPharmacotherapy: [{ drug: 'Bicarbonato de sodio 8.4%', dose: '1-2 mEq/kg IV, repetir según QRS/pH', route: 'IV', notes: 'Meta: QRS estrecho y pH 7.50-7.55; corregir K+.' }, { drug: 'Diazepam/Midazolam', dose: 'Según convulsión', route: 'IV/IM', notes: 'Primera línea; evitar fenitoína.' }, { drug: 'Noradrenalina', dose: '0.05-0.5 mcg/kg/min', route: 'IV', notes: 'Shock refractario tras bicarbonato.' }, { drug: 'Emulsión lipídica 20%', dose: 'Bolo 1.5 ml/kg + infusión según protocolo', route: 'IV', notes: 'Rescate en colapso por fármacos lipofílicos; consultar toxicología.' }] },
    therapeuticWindow: { timeframe: 'Primeras 6 h: máximo riesgo de convulsiones, QRS ancho y arritmias; formulaciones retard o anticolinérgicos prolongan absorción.', goldStandard: 'ECG seriado + bicarbonato para QRS ancho/shock/arritmias + soporte UCI.', alternativeReperfusion: 'Emulsión lipídica o ECMO en colapso refractario donde disponible.', contraindications: ['No fisostigmina.', 'No flumazenil en coingesta desconocida o riesgo convulsivo.', 'No antiarrítmicos IA/IC/III para arritmia por bloqueo de sodio.', 'No hiperventilar/alcalinizar sin control de pH y potasio.'] },
  ...
  },
  {
    ...
    cie10: 'T51.1 / T52.8',
    severity: 'Crítica / Código Rojo',
    summary: 'Alcoholes tóxicos con latencia engañosa: al principio parecen “borrachos”, después aparece acidosis con anion gap. Metanol amenaza visión/SNC; etilenglicol amenaza riñón por oxalato. Si la sospecha es fuerte, el antídoto no espera nivel: fomepizol/etanol bloquean la alcohol deshidrogenasa y la diálisis rescata cuadros graves.',
    ...
    management: { prehospitalAmbulance: ['ABCDE, glucemia y traslado directo a centro con toxicología y hemodiálisis si acidosis, coma, visión alterada o falla renal.', 'No subestimar aparente intoxicación alcohólica con latencia: preguntar por anticongelante, solventes, alcohol adulterado o intento autolítico.', 'Si hay Kussmaul, shock o pH muy bajo y protocolo disponible: bicarbonato mientras se traslada.', 'Llevar envases/muestras y avisar si hay brote por bebida adulterada.'], emergencyRoomShockRoom: ['Calcular anion gap y osmolar gap, pero iniciar fomepizol si sospecha fuerte: no esperar niveles en graves.', 'Fomepizol inmediato; etanol terapéutico solo si no hay fomepizol y con monitoreo estrecho.', 'Bicarbonato para acidosis severa y corrección de electrolitos, especialmente calcio en etilenglicol.', 'Hemodiálisis según EXTRIP si coma, convulsiones, acidosis grave, daño visual, anion gap alto, falla renal o niveles elevados.', 'Cofactores: ácido folínico/folato en metanol; tiamina + piridoxina en etilenglicol.'], initialPharmacotherapy: [{ drug: 'Fomepizol', dose: '15 mg/kg carga; luego 10 mg/kg c/12 h x4 dosis; luego 15 mg/kg c/12 h', route: 'IV', notes: 'Ajustar durante hemodiálisis; antídoto de elección.' }, { drug: 'Etanol', dose: 'Carga y mantenimiento para 100-150 mg/dl', route: 'IV/VO', notes: 'Alternativa si no hay fomepizol; requiere monitoreo.' }, { drug: 'Bicarbonato de sodio', dose: '1-2 mEq/kg según pH', route: 'IV', notes: 'Acidosis severa; puente a diálisis.' }, { drug: 'Ácido folínico/folato', dose: '1 mg/kg hasta 50 mg c/4-6 h', route: 'IV', notes: 'Metanol: favorece metabolismo de formiato.' }, { drug: 'Tiamina + Piridoxina', dose: 'Tiamina 100 mg + Piridoxina 50 mg', route: 'IV', notes: 'Etilenglicol: cofactores metabólicos.' }] },
    therapeuticWindow: { timeframe: 'Horas: el antídoto es más eficaz antes de la metabolización; la diálisis precoz cambia pronóstico en acidosis/visión/renal.', goldStandard: 'Fomepizol + corrección de acidosis + hemodiálisis según criterios EXTRIP + cofactores.', alternativeReperfusion: 'Etanol si no hay fomepizol; traslado urgente a centro con diálisis.', contraindications: ['No esperar niveles si gaps y clínica orientan.', 'No subestimar “borrachera” con acidosis o visión borrosa.', 'No retrasar diálisis con pH bajo, coma, convulsiones, síntomas visuales o AKI.', 'No olvidar coingestas como salicilatos/paracetamol.'] },
  ...
  },
  {
    ...
    cie10: 'T67.0',
    severity: 'Crítica / Código Rojo',
    summary: 'Hipertermia + disfunción neurológica por fracaso termorregulador. Puede haber piel sudorosa: la anhidrosis no es obligatoria. En golpe de calor exertional la regla práctica es “cool first, transport second” si se puede enfriar eficazmente: cada minuto con temperatura central >40 °C aumenta falla multiorgánica.',
    ...
    management: { prehospitalAmbulance: ['Medir temperatura central rectal si es posible; las mediciones axilares/orales pueden subestimar.', 'Retirar ropa/equipo, sombra, rociado con agua + ventiladores + hielo en cuello/axilas/ingles; inmersión en agua fría si disponible.', 'En golpe de calor exertional con recursos de inmersión: enfriar antes de transportar hasta 38.6-39 °C; si no hay método efectivo, enfriar en traslado.', 'Benzodiacepinas si convulsiones, agitación o escalofríos; oxígeno y vía IV sin retrasar enfriamiento.', 'No usar paracetamol/ibuprofeno ni dantroleno de rutina: no corrigen hipertermia ambiental.'], emergencyRoomShockRoom: ['Continuar enfriamiento agresivo con meta 38.6-39 °C y detener para evitar sobreenfriamiento.', 'Cristaloides fríos titulados; monitorizar CK, K+, calcio, creatinina, coagulación, transaminasas y glucemia.', 'Tratar rabdomiólisis, hiperpotasemia, DIC y falla hepática/renal; UCI si alteración SNC o disfunción orgánica.', 'Diferenciar de síndrome serotoninérgico, neuroléptico maligno, sepsis o anticolinérgico, pero no demorar enfriamiento.'], initialPharmacotherapy: [{ drug: 'Cristaloides fríos', dose: 'Bolos titulados a perfusión/diuresis', route: 'IV', notes: 'Coadyuvante; el tratamiento principal es enfriamiento externo rápido.' }, { drug: 'Midazolam/Diazepam', dose: 'Según convulsión/agitación', route: 'IV/IM', notes: 'Reduce producción muscular de calor y protege de convulsiones.' }] },
    therapeuticWindow: { timeframe: 'Bajar temperatura central a 38.6-39 °C idealmente dentro de 30 minutos desde reconocimiento.', goldStandard: 'Enfriamiento rápido, preferentemente inmersión si exertional, + soporte orgánico + control de complicaciones.', alternativeReperfusion: 'Si no hay inmersión: evaporativo intensivo con hielo y ventilación continua durante traslado.', contraindications: ['No paracetamol/ibuprofeno.', 'No dantroleno rutinario en golpe de calor ambiental/exertional.', 'No retrasar enfriamiento por vía IV, laboratorio o traslado si se puede enfriar eficazmente.', 'No confiar en temperatura periférica.'] },
  ...
  },
  {
    ...
    cie10: 'T68',
    severity: 'Crítica / Código Rojo',
    summary: 'Hipotermia accidental con bradicardia, coma o paro potencialmente reversible. La manipulación brusca puede gatillar FV; el pulso puede ser difícil. Regla de oro: nadie está muerto hasta estar caliente y muerto, salvo lesión incompatible con la vida.',
    ...
    management: { prehospitalAmbulance: ['Confirmar pulso/respiración hasta 60 segundos; bradicardia extrema puede simular paro.', 'Manejo suave, horizontal y con mínimo movimiento; quitar ropa mojada, secar, aislar del suelo y cubrir cabeza/cuello.', 'Recalentamiento externo activo en tronco, oxígeno calentado humidificado y fluidos IV tibios si disponibles.', 'Si paro: RCP continua o intermitente si evacuación difícil; desfibrilar FV hasta 3 intentos si T <30 °C y continuar recalentamiento.', 'Traslado a centro con ECLS/ECMO si paro, inestabilidad profunda, T <28-30 °C o potasio/trauma no contraindican.'], emergencyRoomShockRoom: ['Recalentamiento externo activo para moderada; interno/ECLS-ECMO para severa con paro o shock refractario.', 'Evitar intubación demorada si vía aérea no protegida, pero realizarla con manejo cuidadoso porque puede inducir arritmia.', 'Desfibrilar FV/TV; si refractaria por T <30 °C, continuar RCP y recalentar antes de múltiples intentos/fármacos.', 'Diferir fármacos ACLS hasta >30 °C o espaciar intervalos entre 30-35 °C según protocolo.', 'Corregir hipoglucemia, hiperpotasemia, acidosis, trauma, intoxicación o sepsis como causa asociada.'], initialPharmacotherapy: [{ drug: 'Suero tibio', dose: 'Bolos titulados', route: 'IV/IO', notes: 'Coadyuvante; no recalienta solo a un paciente severo.' }, { drug: 'Glucosa', dose: '25 g adulto si hipoglucemia', route: 'IV', notes: 'Corregir causa reversible frecuente.' }] },
    therapeuticWindow: { timeframe: 'Recalentamiento controlado continuo; en paro hipotérmico, RCP prolongada hasta temperatura compatible con vida.', goldStandard: 'Recalentamiento + soporte vital + ECMO/ECLS si paro o inestabilidad severa.', alternativeReperfusion: 'Lavados cavitarios/calor activo si ECMO no disponible.', contraindications: ['No movilizar bruscamente.', 'No declarar muerte sin recalentar salvo lesión incompatible.', 'No calentar extremidades aisladas en severa por riesgo de afterdrop.', 'No suspender RCP prolongada por duración aislada del paro hipotérmico.'] },
  ...
  },
  {
    ...
    cie10: 'T63.0 / T63.3',
    severity: 'Urgencia / Código Amarillo',
    summary: 'Envenenamiento por serpientes o arañas: no es “una herida”, es una intoxicación sistémica potencial. El manejo prehospitalario correcto evita daño: reposo, retirar constricciones y traslado; torniquetes, cortes, succión, hielo o electricidad empeoran. El antiveneno específico se indica por criterios clínicos/laboratorio, no por miedo.',
    ...
    management: { prehospitalAmbulance: ['Alejar de la zona, reposo estricto e inmovilización funcional del miembro; retirar anillos, pulseras y ropa ajustada.', 'Marcar borde del edema con hora y tomar foto segura del animal si no retrasa ni pone en riesgo; no capturarlo.', 'NO torniquete, incisiones, succión, hielo directo, electricidad ni alcohol; no dar AINE si posible coagulopatía.', 'Analgesia, vía IV si signos sistémicos, traslado a centro con antiveneno y preaviso toxicológico.', 'En loxoscelismo, advertir que hemólisis sistémica puede aparecer 24-72 h: orina oscura/fiebre requieren reevaluación.'], emergencyRoomShockRoom: ['ABCDE, marcar edema seriado y laboratorio repetido: plaquetas, TP/KPTT, fibrinógeno, renal, CK, EGO/hemoglobinuria.', 'Antiveneno específico si signos sistémicos, coagulopatía, sangrado, neurotoxicidad, shock o progresión local importante; administrar donde se pueda tratar anafilaxia.', 'Adrenalina IM inmediata si anafilaxia por veneno o antiveneno; no negar antiveneno salvador por miedo a reacción manejable.', 'Soporte respiratorio en neurotoxicidad; hemoderivados preferentemente después de antiveneno si sangrado/coagulopatía persiste.', 'Loxoscelismo sistémico: hidratación, analgesia, curas, tétanos, controles de hemólisis/renal; evitar dapsone rutinario y antibióticos profilácticos sin infección.'], initialPharmacotherapy: [{ drug: 'Antiveneno específico', dose: 'Según especie, región y gravedad', route: 'IV', notes: 'Consultar centro toxicológico; no por profilaxis, sí por envenenamiento clínico/lab.' }, { drug: 'Adrenalina', dose: '0.3-0.5 mg IM adulto', route: 'IM', notes: 'Anafilaxia por veneno o antiveneno.' }, { drug: 'Analgesia no AINE', dose: 'Titulada', route: 'IV/VO', notes: 'Evitar AINE/IM si coagulopatía.' }] },
    therapeuticWindow: { timeframe: 'Antiveneno cuanto antes si criterios; sigue siendo útil mientras haya progresión, coagulopatía o toxicidad sistémica.', goldStandard: 'Identificación clínica/regional + antiveneno específico + soporte respiratorio/hemostático/renal.', alternativeReperfusion: 'Traslado a centro con antiveneno si no disponible, con miembro inmovilizado y controles seriados.', contraindications: ['No torniquete, cortes, succión, hielo directo ni electricidad.', 'No esperar laboratorio si hay neurotoxicidad, shock o sangrado mayor.', 'No AINE/IM si coagulopatía.', 'No antibiótico profiláctico rutinario salvo herida infectada/contaminación clara.'] },
  ...
  },
  {
    ...
    cie10: 'T39.1',
    severity: 'Urgencia / Código Amarillo',
    summary: 'Sobredosis silenciosa: el paciente puede estar bien mientras se instala necrosis hepática. La estrategia es tiempo + nivel + nomograma cuando corresponde, pero si pasaron >8 h, la hora es desconocida o ya hay daño hepático, se inicia N-acetilcisteína sin esperar.',
    ...
    management: { prehospitalAmbulance: ['ABCDE, antiemético si vómitos y traslado con hora exacta, dosis total, peso, formulación y envases; buscar combinados con opioides/anticolinérgicos.', 'Carbón activado 1 g/kg si <4 h, ingesta masiva o liberación prolongada, siempre con vía aérea segura.', 'No demorar NAC si traslado largo, >8 h desde ingesta, hora desconocida con sospecha o síntomas/labs de hepatotoxicidad.', 'Si fue intencional: seguridad, acompañamiento y alerta de salud mental.'], emergencyRoomShockRoom: ['Nivel plasmático a ≥4 h y nomograma Rumack-Matthew solo en ingesta única con hora conocida.', 'Iniciar NAC si nivel sobre línea, presentación >8 h sin nivel inmediato, hora desconocida con sospecha, dosis masiva o hepatotoxicidad.', 'No suspender NAC automáticamente a las 21 h: continuar si paracetamol detectable, ALT/AST o INR empeoran, acidosis, lactato alto o falla hepática.', 'Carbón activado hasta 4 h o más en ingesta masiva/liberación prolongada/coingesta que retrasa vaciamiento.', 'Derivar temprano a centro de trasplante si acidosis, INR alto, encefalopatía, lactato elevado, hipoglucemia o falla renal.'], initialPharmacotherapy: [{ drug: 'N-acetilcisteína', dose: 'IV 150 mg/kg 1 h + 50 mg/kg 4 h + 100 mg/kg 16 h', route: 'IV', notes: 'Máxima eficacia <8 h; continuar según criterios clínico-lab, no por reloj.' }, { drug: 'Carbón activado', dose: '1 g/kg, máximo 50 g', route: 'VO/SNG', notes: 'Ingesta reciente, masiva o liberación prolongada con vía aérea segura.' }] },
    therapeuticWindow: { timeframe: 'NAC ideal antes de 8 h; sigue siendo útil en presentación tardía y falla hepática establecida.', goldStandard: 'Nivel a 4 h + nomograma cuando aplica + NAC precoz y prolongada si criterios.', alternativeReperfusion: 'Si no hay nivel, tratar por dosis/hora/riesgo clínico y consultar toxicología.', contraindications: ['No esperar síntomas.', 'No usar nomograma en ingestas repetidas, liberación prolongada u hora desconocida.', 'No suspender NAC si paracetamol detectable, INR/GOT/GPT empeoran o hay acidosis/encefalopatía.', 'No olvidar coingestas que deprimen sensorio o retrasan absorción.'] },
  ...
  },
  {
    ...
    cie10: 'J93.0 / S27.0',
    severity: 'Crítica / Código Rojo',
    summary: 'Aire pleural a presión con colapso pulmonar, desplazamiento mediastínico y shock obstructivo. Es un diagnóstico clínico de segundos: en paciente inestable no se espera radiografía, se descomprime y luego se coloca drenaje pleural definitivo.',
    ...
    management: { prehospitalAmbulance: ['Oxígeno alto flujo, monitor/desfibrilador y tratar shock como obstructivo hasta descompresión.', 'Si shock + murmullo abolido unilateral/trauma torácico: descompresión inmediata. Sitio preferido: 4°/5° EIC línea axilar anterior/media con catéter largo y grueso; 2° EIC línea medioclavicular es alternativa si protocolo local.', 'Si operador entrenado y catéter falla, toracostomía simple/finger thoracostomy en trauma ventilado o peri-paro.', 'Herida soplante: apósito valvulado o sellado en 3 lados; si empeora, levantar sello para descomprimir.', 'Traslado a centro de trauma, reevaluando recurrencia: un catéter puede obstruirse o ser demasiado corto.'], emergencyRoomShockRoom: ['Drenaje pleural definitivo 4°/5° EIC línea axilar anterior/media después de descompresión.', 'Paro traumático con sospecha torácica: toracostomía bilateral temprana junto a algoritmo de causas reversibles.', 'Ventilación con presiones prudentes tras descompresión; buscar hemotórax, contusión, lesión traqueobronquial o diafragmática.', 'eFAST/Rx solo después de estabilizar o si la clínica no es concluyente en paciente estable.'], initialPharmacotherapy: [{ drug: 'Oxígeno', dose: 'Alto flujo', route: 'Máscara/VM', notes: 'Soporte mientras se descomprime; no sustituye intervención.' }, { drug: 'Analgesia', dose: 'Titulada', route: 'IV', notes: 'No retrasar descompresión por analgesia.' }] },
    therapeuticWindow: { timeframe: 'Segundos-minutos: shock obstructivo progresa a AESP/paro si no se descomprime.', goldStandard: 'Descompresión clínica inmediata + drenaje pleural definitivo.', alternativeReperfusion: 'Toracostomía con dedo si catéter falla y operador entrenado.', contraindications: ['No esperar Rx/TC si shock.', 'No usar catéter corto ni punción medial/inferior al borde costal.', 'No ocluir completamente herida abierta sin válvula.', 'No descartar tensión porque no hay desviación traqueal: es signo tardío.'] },
  ...
  },
  {
    ...
    cie10: 'T17',
    severity: 'Crítica / Código Rojo',
    summary: 'Asfixia mecánica por obstrucción parcial o completa. El algoritmo se decide por dos preguntas: ¿tose eficazmente? ¿está consciente? Tos efectiva se observa; tos inefectiva se interviene; inconsciente se trata como paro hipóxico con RCP y extracción solo bajo visión.',
    ...
    management: { prehospitalAmbulance: ['Obstrucción parcial con tos fuerte: animar a toser, oxígeno si tolera, vigilancia estrecha y traslado si persiste.', 'Adulto/niño >1 año consciente con tos inefectiva: alternar 5 golpes interescapulares con 5 compresiones abdominales; embarazada u obeso: compresiones torácicas.', 'Lactante: 5 golpes interescapulares + 5 compresiones torácicas; NO compresiones abdominales.', 'Si pierde conciencia: iniciar RCP, abrir vía aérea en cada ciclo y retirar solo objeto visible; no barrido digital a ciegas.', 'Magill bajo visión directa si entrenado; si no se puede oxigenar/ventilar por obstrucción alta: vía aérea quirúrgica según entrenamiento/protocolo.'], emergencyRoomShockRoom: ['Laringoscopía directa y extracción con Magill si objeto supraglótico visible.', 'Broncoscopía rígida/flexible urgente si objeto no expulsado o sospecha de aspiración residual.', 'Intubación si edema, agotamiento o hipoxia persistente; cricotiroidotomía en escenario CICO.', 'Observación por edema laríngeo, neumonitis aspirativa, atelectasia o neumonía; Rx/TC no retrasan broncoscopía si obstrucción significativa.'], initialPharmacotherapy: [{ drug: 'Oxígeno', dose: 'Alto flujo', route: 'Máscara/VM', notes: 'Tras alivio parcial o durante soporte.' }, { drug: 'Adrenalina IM', dose: '0.3-0.5 mg adulto', route: 'IM', notes: 'Solo si el cuadro es anafilaxia/edema glótico, no OVACE pura.' }] },
  ...
  },
  {
    ...
    cie10: 'S22.5',
    severity: 'Crítica / Código Rojo',
    summary: 'Fracturas costales múltiples con segmento flotante y respiración paradójica; la gravedad real suele ser la contusión pulmonar subyacente más el dolor que impide ventilar. La flashcard no es “vendar el tórax”: es analgesia potente, soporte ventilatorio y búsqueda activa de neumotórax/hemotórax.',
    ...
    management: { prehospitalAmbulance: ['Oxígeno alto flujo; si hipoxemia o trabajo respiratorio importante, ventilación asistida/CPAP si disponible y no hay contraindicación.', 'Analgesia temprana y titulada: el paciente que no inspira profundo hace atelectasia, hipercapnia y neumonía.', 'No vendaje compresivo circunferencial: reduce ventilación y empeora contusión.', 'Tratar neumotórax a tensión/abierto o hemotórax masivo antes de atribuir todo al flail.', 'Traslado a trauma con reevaluación seriada: la contusión pulmonar puede empeorar en 6-24 h.'], emergencyRoomShockRoom: ['Analgesia multimodal y considerar bloqueo regional/epidural/paravertebral según anticoagulación y lesiones.', 'VNI/CPAP si consciente, colaborador y sin contraindicaciones; intubación con PEEP si fatiga, hipoxemia persistente, shock o TEC.', 'Drenaje pleural si neumotórax/hemotórax; evitar sobrecarga de fluidos que agrava contusión.', 'Fijación quirúrgica costal en casos seleccionados, ideal temprana 48-72 h si estable y disponible.', 'Fisioterapia respiratoria, espirometría incentivada y prevención de neumonía.'], initialPharmacotherapy: [{ drug: 'Fentanilo', dose: '25-100 mcg titulado', route: 'IV/IN', notes: 'Analgesia potente con monitoreo respiratorio.' }, { drug: 'Ketamina', dose: '0.1-0.3 mg/kg analgesia', route: 'IV', notes: 'Útil si hipotensión relativa o se quiere preservar ventilación.' }, { drug: 'Oxígeno/PEEP', dose: 'Según Sat/trabajo respiratorio', route: 'Máscara/VM', notes: 'La PEEP estabiliza ventilación y recluta contusión.' }] },
  ...
  },
  {
    ...
    cie10: 'I26',
    severity: 'Crítica / Código Rojo',
    summary: 'TEP de alto riesgo: hipotensión, shock obstructivo o paro en AESP. El ventrículo derecho falla contra una obstrucción súbita; demasiado volumen lo dilata más. Anticoagulación inmediata si no está contraindicada y reperfusión urgente si inestable.',
    ...
    management: { prehospitalAmbulance: ['Oxígeno, monitor/desfibrilador y acceso IV; pensar TEP en síncope + disnea + factores de riesgo o AESP sin causa clara.', 'Evitar cargas grandes de fluidos; si hipotensión, bolos pequeños de 250-500 ml con reevaluación.', 'Noradrenalina si shock y disponible; mantener perfusión coronaria del VD.', 'Traslado con preaviso a centro con UCI, angioTC, eco, trombólisis/catéter; no demorar en centros sin reperfusión.', 'En paro con alta sospecha de TEP: RCP prolongada y considerar trombólisis según protocolo.'], emergencyRoomShockRoom: ['Paciente inestable: eco bedside para sobrecarga de VD y descartar taponamiento/neumotórax; no enviar a TC al peri-paro.', 'Heparina no fraccionada si no contraindicación, por rápida titulación y compatibilidad con procedimientos.', 'Trombólisis sistémica si TEP alto riesgo con shock persistente o paro probable; alteplasa 100 mg/2 h o esquema de paro local.', 'Embolectomía quirúrgica/catéter o ECMO como puente si contraindicación/falla de lisis o shock refractario.', 'Ventilación cuidadosa: la presión positiva puede bajar retorno venoso y empeorar VD.'], initialPharmacotherapy: [{ drug: 'Heparina no fraccionada', dose: '80 UI/kg bolo + 18 UI/kg/h', route: 'IV', notes: 'Preferida en inestable si no contraindicación.' }, { drug: 'Alteplasa', dose: '100 mg IV en 2 h o protocolo de paro', route: 'IV', notes: 'TEP masivo con shock/parada si beneficio supera riesgo hemorrágico.' }, { drug: 'Noradrenalina', dose: '0.05-0.5 mcg/kg/min', route: 'IV', notes: 'Soporte de shock obstructivo/VD.' }] },
  ...
  },
  {
    ...
    cie10: 'S36',
    severity: 'Crítica / Código Rojo',
    summary: 'Trauma abdominal con dos amenazas: víscera maciza que sangra y víscera hueca que contamina. El abdomen puede estar “tranquilo” mientras el paciente se desangra. Inestable + FAST positivo/peritonitis/evisceración es cirugía, no tomografía.',
    ...
    management: { prehospitalAmbulance: ['XABCDE: controlar hemorragia externa antes de abdomen; oxígeno, monitor, dos vías/IO y abrigo activo.', 'Hipotensión permisiva en trauma penetrante sin TEC: objetivo pulso radial/estado mental, no presión “normal” con cristaloides.', 'TXA si hemorragia significativa dentro de 3 h; minimizar cristaloides fríos.', 'Evisceración: cubrir con gasas estériles húmedas y apósito oclusivo suave; no reintroducir ni comprimir.', 'Empalamiento: no retirar objeto; estabilizarlo y cortar solo si impide traslado.', 'Preaviso a centro de trauma/cirugía; el recurso definitivo es control de hemorragia/contaminación.'], emergencyRoomShockRoom: ['Activar protocolo de transfusión masiva si shock: hemoderivados balanceados, calcio, temperatura y coagulopatía.', 'eFAST inmediato: inestable + FAST positivo, peritonitis o evisceración = laparotomía/control de daños.', 'Paciente estable = TC con contraste; manejo no operatorio de órgano sólido solo con cirugía, UCI, sangre y angioembolización disponibles.', 'Antibióticos y tétanos en trauma penetrante, evisceración o sospecha de víscera hueca.', 'Control de daños: packing, hemostasia, control de contaminación y cierre temporal si fisiología agotada.'], initialPharmacotherapy: [{ drug: 'Hemoderivados', dose: 'Protocolo de transfusión masiva', route: 'IV/IO', notes: 'Reanimación hemostática temprana; evitar cristaloides excesivos.' }, { drug: 'Ácido tranexámico', dose: '1 g IV + 1 g en 8 h si <3 h', route: 'IV', notes: 'Hemorragia traumática significativa; no iniciar tarde.' }, { drug: 'Cefazolina/Ceftriaxona + Metronidazol', dose: 'Según protocolo', route: 'IV', notes: 'Penetrante, lesión hueca o evisceración.' }, { drug: 'Calcio', dose: 'Según ionizado/protocolo masivo', route: 'IV', notes: 'Transfusión masiva: prevenir hipocalcemia por citrato.' }] },
  ...
  },
  {
    ...
    cie10: 'T79.6 / M79.A',
    severity: 'Crítica / Código Rojo',
    summary: 'Aumento de presión dentro de un compartimento osteofascial hasta cerrar perfusión capilar. Los pulsos pueden estar presentes: esperarlos es tarde. Dolor desproporcionado y dolor con estiramiento pasivo son la alarma; el tratamiento es fasciotomía urgente.',
    ...
    management: { prehospitalAmbulance: ['Retirar yesos/vendajes/cintas y cualquier constricción; cortar hasta piel si hay férula circular.', 'Férula funcional y miembro a nivel del corazón: no elevar alto porque reduce perfusión, no dejar colgando porque aumenta edema.', 'Analgesia potente sin “tapar” la reevaluación; dolor que reaparece o escala es dato clínico.', 'No hielo directo ni compresión; oxígeno, evitar hipotensión y traslado con preaviso a ortopedia/trauma.', 'En aplastamiento: vigilar hiperpotasemia/rabdomiólisis y preparar fluidos.'], emergencyRoomShockRoom: ['Ortopedia/cirugía urgente: fasciotomía si clínica clara, sin esperar medición.', 'Medir presión compartimental si paciente inconsciente, sedado, politrauma o diagnóstico dudoso; delta presión ≤30 mmHg o presión absoluta alta apoya cirugía.', 'Tratar fractura, lesión vascular o reperfusión asociada; documentar neurovascular seriado.', 'Hidratación y monitoreo de CK, K+, calcio, creatinina y mioglobinuria si aplastamiento/rabdomiólisis.', 'Evitar bloqueos regionales densos sin plan estricto de vigilancia porque pueden ocultar evolución.'], initialPharmacotherapy: [{ drug: 'Fentanilo/Ketamina', dose: 'Titulada', route: 'IV/IN', notes: 'Analgesia; dolor persistente pese a analgesia refuerza sospecha.' }, { drug: 'Cristaloides', dose: 'Titulados a diuresis', route: 'IV', notes: 'Rabdomiólisis/aplastamiento.' }, { drug: 'Calcio + insulina/glucosa', dose: 'Según hiperpotasemia', route: 'IV', notes: 'Si hiperpotasemia por aplastamiento.' }] },
    therapeuticWindow: { timeframe: 'Fasciotomía ideal antes de 6 h; necrosis y neuropatía irreversible aumentan después de 6-8 h.', goldStandard: 'Diagnóstico clínico precoz + fasciotomía urgente de todos los compartimentos afectados.', alternativeReperfusion: 'Medición de presión si duda o paciente no evaluable, sin demorar si clínica clara.', contraindications: ['No esperar las “5P” ni ausencia de pulso.', 'No elevar alto el miembro ni aplicar hielo directo.', 'No cerrar yeso/vendaje apretado.', 'No usar bloqueo regional denso sin vigilancia quirúrgica.'] },
  ...
  },
  {
    ...
    cie10: 'T14.1 / S21-S31',
    severity: 'Crítica / Código Rojo',
    summary: 'Trauma penetrante por HAF, HAB o empalamiento: la anatomía visible subestima el trayecto real, sobre todo en arma de fuego. La supervivencia depende de XABCDE, control de hemorragia, sello torácico si corresponde y tiempo mínimo hasta cirugía/control de daños.',
    ...
    management: { prehospitalAmbulance: ['Seguridad de escena y XABCDE: hemorragia exanguinante antes que vía aérea si sangra a chorro.', 'Control de hemorragia: presión directa, apósito hemostático/packing en zonas compresibles y torniquete alto y apretado en extremidades con sangrado masivo.', 'NO retirar cuchillo, varilla u objeto empalado; estabilizarlo y cortar solo si impide traslado o RCP.', 'Herida torácica soplante: sello torácico ventilado o apósito en 3 lados; reevaluar por neumotórax a tensión.', 'Hipotensión permisiva si no hay TEC: evitar cristaloides excesivos; TXA si hemorragia significativa <3 h.', 'Traslado rápido a centro quirúrgico: no sondar heridas, no explorar trayectos, no buscar proyectiles en campo.'], emergencyRoomShockRoom: ['Activar trauma/cirugía y transfusión masiva si shock; hemoderivados balanceados, calcio, temperatura y corrección de coagulopatía.', 'eFAST y examen por regiones; inestable con foco torácico/abdominal/pélvico = quirófano o toracotomía según caso, no TC.', 'Antibióticos y profilaxis antitetánica según contaminación, abdomen, tórax abierto o empalamiento.', 'Control de daños: toracotomía/laparotomía/vascular, packing y cierre temporal si tríada letal.', 'Toracotomía de resucitación solo en paro traumático penetrante seleccionado con signos de vida recientes y equipo entrenado.'], initialPharmacotherapy: [{ drug: 'Ácido tranexámico', dose: '1 g IV + 1 g en 8 h', route: 'IV', notes: 'Hemorragia traumática dentro de 3 h; no iniciar tarde.' }, { drug: 'Hemoderivados', dose: 'Protocolo masivo', route: 'IV/IO', notes: 'Reanimación hemostática; evitar cristaloides excesivos.' }, { drug: 'Cefazolina ± Metronidazol', dose: 'Según herida', route: 'IV', notes: 'Penetrante/contaminada/abdominal.' }, { drug: 'Profilaxis antitetánica', dose: 'Según esquema', route: 'IM', notes: 'Vacuna/inmunoglobulina según antecedente.' }] },
    therapeuticWindow: { timeframe: 'Minutos: minimizar tiempo en escena y llevar a control quirúrgico; la hemorragia no controlada mata antes que la mayoría de los estudios.', goldStandard: 'Control de sangrado + traslado a centro de trauma + cirugía/control de daños.', alternativeReperfusion: 'REBOA/toracotomía de resucitación en centros entrenados y criterios precisos.', contraindications: ['No retirar empalamientos fuera de quirófano.', 'No explorar ni sondar heridas profundas en campo.', 'No retrasar traslado por intervenciones no esenciales.', 'No cerrar herméticamente una herida torácica sin mecanismo de ventilación.', 'No normalizar presión con cristaloides en hemorragia penetrante sin TEC.'] },
